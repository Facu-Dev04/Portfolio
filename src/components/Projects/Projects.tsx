    ...
    return (
        <main className="relative pt-20 ">
            ...
            <section className="grid grid-cols-3 gap-y-32 mt-10 grid-flow-row grid-rows-2 justify-center items-center gap-x-5 max-[1200px]:grid-cols-2 max-[900px]:grid-cols-1 mb-20">
                <ProjectCards
                    url={"/img/Project/Easy_Turno/easy_turnos.png"}
                    title="Easy Turnos"
                ...
                />
                <ProjectCards
                    url={"/img/Project/HRNexo/HRNexo_3.png"}
                    title="Gestión de RRHH en la nube"
                    parrafo="Aplicación HRNexo en React y Django para gestión eficiente de RRHH. Escalable y moderna, incluye funciones clave."
                ...
                <ProjectCards
                    url={"/img/Project/Justina_io/Justina.jpg"}
                    title="Justina.io"
