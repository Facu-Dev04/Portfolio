...
import Contact from '@/components/Contact/Section_Contact';
...
export default function Home() {
  ...
  return (
    <main ref={bannerRef} className="banner flex flex-col relative">
      <div className="flex flex-col flex-grow overflow-y-auto scroll-smooth">
        ...
        <section className='w-full flex justify-center items-center mt-10 z-50'>
          <Header />
        </section>
        <section id="hero" className="flex mt-16">
          <Hero />
        </section>
        <section id="experiencia" className="flex justify-center items-center h-auto pt-20 pb-20">
          <ExperienceSection />
        </section>
        <section id="habilidades">
          <Section_Skill />
        </section>
        <section id="proyectos" className="md:mb-0">
          <Projects />
        </section>
        <section id='contact' className="z-30 md:mt-0" >
          <Contact />
        </section>
      </div>
      <div className='mt-20'>
