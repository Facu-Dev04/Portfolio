export const EXPERIENCE = [
  {
    id: "job1",
    title: "Freelance - Epoca Bags",
    position: "Developer FullStack",
    url: "https://epoca-bags.vercel.app/",
    startDate: "Noviembre - Diciembre 2025",
    endDate: "",
    description:
      "Ecommerce Virtual para la venta de Bolsos para Hombre, un ecommerce funcional, que integra pasarela de pago, sistema de envios y un chatbot para asistencia a clientes.",
  },
  {
    id: "job2",
  ...
  },
  {
    ...
    endDate: "",
    description:
      "Desarrollé toda la interfaz del dashboard para Easy Turno, enfocándome en la configuración del sistema de gestión de turnos para profesionales. Esto incluyó una investigación exhaustiva y la integración de diversas APIs en el frontend, permitiendo visualizar toda la información relevante de los clientes que reservan citas. Este sistema facilita a los profesionales gestionar sus turnos de manera eficiente.",
  },
  {
    id: "job5",
